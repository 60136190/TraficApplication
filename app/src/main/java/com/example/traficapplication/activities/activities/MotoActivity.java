...
public class MotoActivity extends AppCompatActivity {
    ...
    private void defineAdapter() {
        ...
        if (b.get("lawPos").equals("1")) {
            ...
            itemAdd(R.drawable.img_1, "Chuyển đường không đúng nơi được phép hoặc không có tín hiệu báo trước", "Phạt tiền từ 100.000 đồng đến 200.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("2")){
            ...
            itemAdd(R.drawable.img_1, "Dừng xe ở nơi có biển “Cấm dừng và đổ xe”", "Phạt tiền từ 200.000 đồng đến 300.000 đồng", "cascas");
            itemAdd(R.drawable.img_1, "Dừng xe, đỗ xe trên phần đường xe chạy ở đoạn đường ngoài đô thị nơi có lề đường", "Phạt tiền từ 200.000 đồng đến 300.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("3")){
            ...
            itemAdd(R.drawable.img_1, "Điều khiển xe không còi hoặc còi không có tác dụng", "Phạt tiền từ 100.000 đồng đến 200.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("5")){
            ...
            itemAdd(R.drawable.img_1, "Xếp hàng hóa vượt quá mức quy định", "Phạt tiền từ 400.000 đồng đến 600.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("6")){
            ...
            itemAdd(R.drawable.img_1, "Điều khiển xe không có gương chiếu hậu bên trái nhưng người điều khiển hoặc có nhưng không có tác dụng", "Phạt tiền từ 100.000 đồng đến 200.000 đồng", "cascas");
            ...
            itemAdd(R.drawable.img_1, "Bán biển số xe mô tô xe gắn máy kể cả xe điện và các loại xe tương tự xe gắn máy mà không phải là biển số do cơ quan nhà nước có thẩm quyền sản xuất hoặc không được cơ quan nhà nước có thẩm quyền cho phép ", "Phạt tiền từ 1.000.000 đồng đến 4.000.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("9")){
            ...
            itemAdd(R.drawable.img_1, "Không có giấy phép  lái xe  hoặc sử dụng giấy phép không do cơ quan thẩm quyền cấp, giấy phép bị tẩy xóa", "Phạt tiền từ 800.000 đồng đến 1.200.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("10")){
            ...
            itemAdd(R.drawable.img_1, "Điều khiển xe kéo theo xe khác,vật khác", "Phạt tiền từ 400.000 đồng đến 600.000 đồng", "cascas");
